...
import { MarkerType } from '@angflow/angular';
...
const config: FlowConfig = {
  ...
  edges: [
    ...
    { id: 'markers', source: '9', target: '11', label: 'markers', markerEnd: { type: MarkerType.Arrow }, markerStart: { type: MarkerType.ArrowClosed } },
...
export class EdgesGeneralComponent {
  config = config;
}

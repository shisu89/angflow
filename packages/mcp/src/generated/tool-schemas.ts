...
export const AGENT_TOOL_SCHEMAS: AgentToolSchema[] = [
  ...
  {
    "name": "get_state",
    "description": "Return a snapshot of a flow: { nodes, edges, viewport, collapsedHiddenIds }. collapsedHiddenIds lists nodes hidden because an ancestor group is collapsed. Optionally scope to a group subtree (groupId) OR a bounds rect (bounds) — not both. For a compact overview of a large board, prefer get_summary.",
    "inputSchema": {
      "type": "object",
      "properties": {
        "flowId": {
